...
public class AccusationResult {
    ...
    public AccusationResult(boolean success, String message, boolean cheatExposed, CheatType actualCheatType) {
    ...
    public boolean isCheatExposed() {
        return cheatExposed;
    }

    public CheatType getActualCheatType() {
        return actualCheatType;
    }
}